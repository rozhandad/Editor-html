...
function getTitle() {
    ...
    if (titleCheck == '' || titleCheck == null) {
        alertify.alert("WARNING:<br/> ");
        $('#dummy-title').val("Free-Learn demo");
    }
    // If <title> is missing
    else {
...
function downloadZip() {
    ...
    var cssLink = "<" + "link href=\"css/style.css\" rel=\"stylesheet\" type=\"text/css\"" + "/>" + "\n";
    var jsLink = "<" + "script src=\"js/script.js\" type=\"text/javascript\">" + "</" + "script" + ">" + "\n";
